...
# =========================================================
APP_VERSION = "T37_LOTNO_OCR_FIX_TOA_TOB"
...
def process_inner_yolo_roi_ocr(image_path, camera_key):
    ...
    for idx, det in enumerate(detections, start=1):
        ...
        ocr_clean_fixed, ocr_fix_applied, lot_pattern_valid = fix_lot_no_by_field(ocr_clean_original, field_key)
        ...
        item = {
            ...
            "lot_pattern_valid": lot_pattern_valid,
            "items": ocr.get("items", []),
        }
        by_class[name] = item
        if field_key:
...
def init_job_data():
    ...
    job_data = {
        "project": "AI-Based Validation System for Shipping Label Verification",
        "design_version": "T37_LOTNO_OCR_FIX_TOA_TOB",
...
root.title("AI Camera Station - Mock API - T37 LOT NO OCR Fix")
