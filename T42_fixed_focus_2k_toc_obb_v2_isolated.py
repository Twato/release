...
# =========================================================
APP_VERSION = "T42_FIXED_FOCUS_2K_TOC_OBB_V2_ISOLATED"
...
def init_job_data():
    ...
    job_data = {
        "project": "AI-Based Validation System for Shipping Label Verification",
        "design_version": "T42_FIXED_FOCUS_2K_TOC_OBB_V2",
...
root.title("AI Camera Station - Mock API - T42 Isolated Fixed Focus 2K + TOC OBB V2")
