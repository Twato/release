...
# =========================================================
APP_VERSION = "T35_STRICT_DETECTION_RESULT_NO_FAKE_FALLBACK"
...
CAM1_INNER_DETECTION_MODEL_PATH = "/home/toto/AI_CAMERA_TEST_YOLO_ROI/Models/TOA_model/train_toa_obb_v3.pt"
CAM2_INNER_DETECTION_MODEL_PATH = "/home/toto/AI_CAMERA_TEST_YOLO_ROI/Models/TOB_model/train_tob_obb_v3.pt"
...
def get_inner_field_data(data, field_key, fallback=None):
    ...
    T35: If a field is missing, return fallback if explicitly provided; otherwise return {}.
...
def init_job_data():
    ...
    job_data = {
        "project": "AI-Based Validation System for Shipping Label Verification",
        "design_version": "T34_OBB_RESULT_LINKED_DETECTION",
...
root.title("AI Camera Station - Mock API - T35 Strict Detection Result")
